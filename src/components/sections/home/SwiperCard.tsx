...
const SwiperCard = ({ article }: SwiperCardProps) => {
  return (
    <div className="rounded-lg overflow-hidden flex flex-col justify-center items-center md:flex-row bg-[#FAFAFA]">
      ...
      <div className="w-full md:w-1/2 h-48 md:h-auto">
        <Image src={article.image} alt="" width={600} height={400}/>
      </div>
    </div>
  );
};
